                    ...
                    if(findTable.hasClass('eChkColor')){
                        ...
                        var findNoRowChk = findfixbodyTarget.find('tbody tr').each(function(i){
                            if(!$(this).children().children().hasClass('rowChk')){
                                if(findThis.is(':checked')){
                                    if(settings.fixColumn > 0){
                                        findfixcolTarget.find('tbody tr').eq(i).addClass('selected');
                                    }
                                    findfixbodyTarget.find('tbody tr').eq(i).addClass('selected');
                                }else{
                                    if(settings.fixColumn > 0){
                                        findfixcolTarget.find('tbody tr').eq(i).removeClass('selected');
                                    }
                                    findfixbodyTarget.find('tbody tr').eq(i).removeClass('selected');
                                }
                            }
                        });
                    }
