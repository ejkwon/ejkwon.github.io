...
var SUIO = function(){
   ...
   // mLayer : close
        ...
        for (var i = 0; i < 4; i++) {
            ...
            if (cur.tagName.toUpperCase() === 'LABEL') {
                ...
                if (target.checked && hasClass === false) {
                    ...
                    var newClass = className + ' eSelected';
                    cur.className = newClass.replace(/\s+/g, ' ');
                    //$(cur).addClass('eSelected');
                } else if ( ! target.checked && hasClass === true) {
                    cur.className = className.replace(regexpSelectedClassName, '');
                    //$(cur).removeClass('eSelected');
                }
                break;
            }
        }
    ...
    $(function(){
        ...
        //findTarget.find('.total, .result, .eLayerClick').click(function() {
        ...
        //findTarget.find('.total, .result, .eLayerClick').mouseover(function() {
            flagSelect = false;
        });
        ...
        //findTarget.find('.total, .result, .eLayerClick').mouseout(function() {
            flagSelect = true;
        });
        ...
        //$('.inputFormArea > a').mousedown(function(e){
        ...
        //$('.inputFormArea > a').mouseup(function(e){
            if($(this).next('.eToggle').css('display') == "none"){
        ...
        //findTarget.find('select').mousedown(function() {
            flagSelect = false;
        });
        ...
        //findTarget.find('select').change(function() {
            flagSelect = true;
        ...
        //findTarget.find('select').focusout(function(e){
            $(this).parents('.eToggle').removeClass('selected');
            flagSelect = true;
        });
    });
