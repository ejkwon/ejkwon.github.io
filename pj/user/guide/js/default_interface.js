...
function gui_addArea(id) {
	...
	temp+= '<input type="text" name="img_href" class="img_href" value="" placeholder="랜딩경로(href)">';
...
function textAddEvent(str) {
	...
	if(radionum == 1){
		...
		tagStr += '    <tr>\n';
		tagStr += '        <td style="font-size:0; line-height:0;">\n';
		...
		tagStr += '                                    본 메일은 0000년 00월 00일 기준으로 회원님의 카페24 이메일 수신동의 여부를 확인한 결과,<br />수신에 동의하였기에 발송되었습니다. <br />메일 수신을 원하지 않으시면 <a href="https://user.cafe24.com/unsubscribe/?email=[$etc1]"><img src="http://m-img.cafe24.com/images/webzine/center/btn_deny.gif" alt="수신거부" border="0" style="vertical-align: middle;"></a> 를 클릭해 주십시오.<br /><br />If you do not want to receive emails from us, please click here. [<a href="https://user.cafe24.com/unsubscribe/?email=[$etc1]" style="text-decoration:none; font-weight:bold; color:#8a8e94; ">HERE</a>]<br />본 메일은 발신전용으로 회신되지 않으므로 문의사항은 [고객센터]를 이용하여 주시기 바랍니다.\n';
		tagStr += '                                </td>\n';
		tagStr += '                            </tr>\n';
		tagStr += '                            <tr>\n';
		tagStr += '                                <td style="padding:15px 0 13px; border-top:1px solid #d7d7d7; font-size:11px; line-height:18px; color:#8a8e94; font-family:Tahoma,Dotum;"><strong style="color:#67696b; font-size:12px;">심플렉스인터넷</strong>(주)<span style="color:#c3c3c3;">|</span> 대표이사 : 이재석<br />주소 : 서울특별시 동작구 보라매로5길 15(신대방동, 전문건설회관)<br />사업자등록번호 : 118-81-20586 <span style="color:#c3c3c3;">|</span> 통신판매업신고 : 동작 제 02-680-078호 <br />전화번호 : 1588-3284 &nbsp; 팩스 : 02-6280-0331 &nbsp;전자우편 : <a href="mailto:echosting@cafe24.com" style="color:#8a8e94; text-decoration:none;">echosting@cafe24.com</a></td>\n';
		tagStr += '                            </tr>\n';
		tagStr += '                            <tr>\n';
		tagStr += '                                <td style="padding:15px 0 0;"><img src="http://m-img.cafe24.com/images/template/ec/txt_footer_copy.gif" alt="Copyright&copy; Simplex Internet Inc.All Rights Reserved." border="0" /></td>\n';
		tagStr += '                            </tr>\n';
		tagStr += '                        </table>\n';
		tagStr += '                    </td>\n';
		...
		tagStr += '            <img src="http://m-img.cafe24.com/images/template/soho/img_header1.gif" alt="cafe24 창업센터" usemap="#logoMap" border="0">\n';
...
function saveAs(newHtml, fileName){
	...
	if(agent.indexOf('Trident')>0){				//ie 일때
		console.log("ie");
