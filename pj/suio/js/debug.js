...
;(function (global, $) {
    ...
    function eDebugBegin(opts){
        ...
        $.getScript("/pj/suio/js/debugbot_ui.js", function() {    //디버깅 ui js
            $.fn.eDebug(opts);
        });
    }
...
$(function(){
    ...
    if(flagWin){
        // debug.css import
        $('body').append('<link rel="stylesheet" type="text/css" href="/pj/suio/css/debug.css" media="all" />');
        if($(location).attr('host') == "fe.cafe24test.com") {
            $('body').append('<link rel="stylesheet" type="text/css" href="/pj/suio/css/debug_test.css" media="all" />');
        }
    }
});