...
<?php
    ...
    for($flag=0; $flag<count($lnb); $flag++) {
        ...
        if($lnb[$flag]['debug'] == ''){
            ...
            $debug = '<a href="/suio/debug_css.html#'.$lnb[$flag]["debug"].'" class="debug" target="_blank" title="새창열림">[D]</a>';
        }
        //ec
        if($lnb[$flag]['ec'] == ''){
            $ec ='';
        ...
        // lnb
        if($lnb[$flag]['ec'] == 'ec'){
            $lnb_menu = $lnb_menu . '<li class="'. $ready . $selected .'">'. $debug .'<a href="/suio/include/layout.php?MODULE='. $lnb[$flag]['file'] .'">'. $ready_msg . $lnb[$flag]['module'] .'<span class="icoEC">EC</span></a></li>';
        } else if($lnb[$flag]['ec'] == 'new'){
            $lnb_menu = $lnb_menu . '<li class="'. $ready . $selected .'">'. $debug .'<a href="/suio/include/layout.php?MODULE='. $lnb[$flag]['file'] .'">'. $ready_msg . $lnb[$flag]['module'] .' <span class="icoNew">new</span></a></li>';
        } else {
            $lnb_menu = $lnb_menu . '<li class="'. $ready . $selected .'">'. $debug .'<a href="/suio/include/layout.php?MODULE='. $lnb[$flag]['file'] .'">'. $ready_msg . $lnb[$flag]['module'] .'</a></li>';
        }
    }
...
<head>
    <meta charset="utf-8" />
    <title>cafe24 SUIO :: Japan</title>
    <link rel="stylesheet" type="text/css" href="/css/suio.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/css/ec/common.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/css/library.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/suio/css/style.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/suio/css/theme/default.css" media="all" id="codeTheme" />
    <link rel="stylesheet" type="text/css" href="/suio/css/debug.css" media="all" />
    <link rel="stylesheet" type="text/css" href="/suio/css/debug_test.css" media="all" />
    <!--[if lt IE 9]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
    <script type="text/javascript" src="/js/suio.js"></script>
    <script type="text/javascript" src="/js/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="/suio/js/prettify.js"></script>
    <script type="text/javascript" src="/suio/js/lang-css.js"></script>
    <script type="text/javascript" src="/suio/js/fakescroll.js"></script>
    <script type="text/javascript" src="/suio/js/ui.js"></script>
    <script type="text/javascript" src="/suio/js/ZeroClipboard.js"> </script>
...
<body <?=$xml?>>
    <div id="uioWrap">
        <header id="uioHeader">
            <h1><a href="/suio/">SUIO</a></h1>
            <nav class="uioNavigation">
                <a href="/suio/module_search.html" target="_blank">모듈명 뽑기</a>
                <a href="/suio/support_converter.html" target="_blank">Support Converter</a>
                <a href="/suio/code_replace.html" target="_blank">꺽쇠변환</a>
                <a href="/suio/xml_create.php" target="_blank">suio.xml 생성</a>
                <a href="/suio/ex_find.html" target="_blank">SUIO FIND</a>
                <a href="/suio/include/layout.php?MODULE=imageList">공통 이미지</a>
    ...
    <?php if($_GET['MODULE'] == 'board_row_write'){ ?>
        ...
        $(document).ready(function(){
            $.get(window.location.origin+"/suio/module/board_nation.html", function(data, status){
