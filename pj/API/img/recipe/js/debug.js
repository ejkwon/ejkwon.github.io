$(function(){
    /***************************************************** 수정범위 *****************************************************/
        var debugCSS = "/img.echosting.cafe24.com/api/recipe/css/debug.css"; // ★ 해당 프로젝트의 디버깅 CSS 경로로 수정해주세요.
    /*************************************************** //수정범위 *****************************************************/

    $('head link:last').after('<link rel="stylesheet" type="text/css" href="'+debugCSS+'" media="all" id="template_css" />');
    templateSwitch('on');
